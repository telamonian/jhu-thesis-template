...
\usepackage[left=1.5in,top=1.0in,right=1.0in,bottom=1.0in,nohead,foot=0.5in]{geometry}
\usepackage{setspace}
%\setstretch{1.05}
...
{\bf October, 2019} \\     % change it accordingly!
\vspace*{.5in}
\begin{small}
...
%\includepdf[pages={-}, pagecommand={}]{cv/cv_max_klein.pdf}
