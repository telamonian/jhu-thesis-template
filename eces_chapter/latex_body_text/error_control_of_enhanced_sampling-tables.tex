...
\begin{table}[h]
    \caption{\label{tab:rem}Parameterization and other simulation data from our simplified \remname{} (\remabbrev{}). The phase weights $\pwtrue$ were copied from those of $\GTSSLOWER$ (see \tableref{tab:gts}). All sample costs $\pcsymb$ were set to $1$.}
    ...
    \end{tabularx}
\end{table}
\footnotetext[1]{The phase weight of phase $\phase$.}
\footnotetext[2]{The expected cost of a failed phase $\phase$ trajectory.}
\footnotetext[3]{The expected cost of a successful phase $\phase$ trajectory.}
\footnotetext[4]{The expected cost of a phase $\phase$ sample.}
\footnotetext[5]{The phase $\phase$ sample count (in thousands) for a 1\% error goal with 95\% confidence.}
\clearpage
...
\begin{table}[h]
    \caption{\label{tab:srg}Parameterizations and other simulation data from our \srgabbrev{} models. Per-phase weights, costs, and sample counts were estimated from the average results of 1000 \abr{FFPilot} simulations (1\% error goal). \abr{MFPT} values were estimated from the results of $10^5$ \abr{DS} simulations, plus or minus the 95\% confidence interval bounds.}
    \begin{tabularx}{\textwidth}{XX}
    \hline\hline
        \begin{tiny}
    ...
    \end{tabularx}
\end{table}
\footnotetext[1]{The position of interface $\phase$ in terms of order parameter $\srga$.}
\footnotetext[2]{The phase weight of phase $\phase$.}
\footnotetext[3]{The expected cost of a failed phase $\phase$ trajectory.}
\footnotetext[4]{The expected cost of a successful phase $\phase$ trajectory.}
\footnotetext[5]{The expected cost of a phase $\phase$ sample.}
\footnotetext[6]{The phase $\phase$ sample count (in thousands) for a 1\% error goal with 95\% confidence.}
\clearpage
...
\begin{table}[h]
    \caption{\label{tab:gts}Parameterizations and other simulation data from our \gtsabbrev{} models. Per-phase weights, costs, and sample counts were estimated from the average results of 1000 \abr{FFPilot} simulations (1\% error goal). \abr{MFPT} values were estimated from the results of $10^5$ \abr{DS} simulations, plus or minus the 95\% confidence interval bounds.}
    \begin{tabularx}{\textwidth}{XX}
    \hline\hline
        \begin{tiny}
    ...
    \end{tabularx}
\end{table} 
\footnotetext[1]{The position of interface $\phase$ in terms of order parameter $\gtsbma$.}
\footnotetext[2]{The phase weight of phase $\phase$.}
\footnotetext[3]{The expected cost of a failed phase $\phase$ trajectory.}
\footnotetext[4]{The expected cost of a successful phase $\phase$ trajectory.}
\footnotetext[5]{The expected cost of a phase $\phase$ sample.}
\footnotetext[6]{The phase $\phase$ sample count (in thousands) predicted by \abr{FFPilot} to achieve a 1\% error goal, 95\% confidence.}
\clearpage
